...
export class LoggerModule {
  static forRoot(options: LoggerModuleOptions, isGlobal = false): DynamicModule {
    return {
      global: isGlobal,
      module: LoggerModule,
      providers: [
  ...
  static forRootAsync(options: LoggerModuleAsyncOptions, isGlobal = false): DynamicModule {
    return {
      global: isGlobal,
      module: LoggerModule,
